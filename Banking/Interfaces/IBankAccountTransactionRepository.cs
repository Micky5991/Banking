...
namespace Micky5991.Banking.Interfaces
{
    ...
    {
        /// <summary>
        /// Logs a transaction that should be assigned to <see cref="transactionReceipient"/> and remembers the <paramref name="transactionOpposite"/> <see cref="IBankAccount"/>.
        /// Because the transactions are persisted in a double-entry ledger the <see cref="transactionReceipient"/> can be either the sender of this amount and the receiver.
        /// </summary>
